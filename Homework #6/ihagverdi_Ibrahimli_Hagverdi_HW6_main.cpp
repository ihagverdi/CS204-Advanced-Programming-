...
#include <fstream>
#include <sstream>
#include "ihagverdi_Ibrahimli_Hagverdi_HW6_board.h" //change this with your board header file name
#include "ihagverdi_Ibrahimli_Hagverdi_HW6_player.h" //change this with your player header file name
